...
14. `gcloud run services replace service.yaml --region us-east1 --project wedge-golf`
15. `touch gcr-service-policy.yaml`
16. `gcloud run services set-iam-policy custom-fastapi-service gcr-service-policy.yaml --region us-east1 --project wedge-golf-dev`
